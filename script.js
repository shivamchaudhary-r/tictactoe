...
var TicTacToe = {
    ...
    checkWin: function() {
        var ttt = this;
        // if for any of the winning sets, every square in the set is filled with
        // the current player's symbol, return true otherwise, return false
    ...
    // check if there is a draw
    checkDraw: function() {
        // return true if every square has more than 1 class (is filled) otherwise, return false
